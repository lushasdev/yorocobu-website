...
aliases:
  [yorocobu llc, the company, what is yorocobu, what is this, who are you,
   ...
   where are you based, where are you located, when was yorocobu founded, wyoming,
   chapel hill, are you remote]
status: active
kind: about
founded: 2025
...
do_not_claim:
  ...
  - No headcount beyond the two named founders is public.
  - Wyoming is where the LLC is filed. It is not an office, a headquarters, or where anyone works, and no one is described as being in Wyoming.
