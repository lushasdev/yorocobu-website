...
nav_order: 6
title: Contact
aliases: [email, get in touch, reach out, how do i contact you, how do i reach you,
  talk to someone, investors, linkedin, instagram, social,
  can you send a question to ethan, can you contact him for me, can you pass on a message,
...
links:
  ...
  - label: Instagram
    url: https://www.instagram.com/yorocobu/
do_not_claim:
  - Never promise a reply, or say when one will come. Whether and when Ethan answers is not something the site knows.
  - Never say a message has been sent, received, or read. Nothing is sent until the visitor presses send themselves, and the confirmation for that comes from the site rather than from Joy.
